...
public class AllAdapter extends RecyclerView.Adapter<AllAdapter.ViewHolder> {
    ...
    public AllAdapter(List<ReservationFormCustom> list, Context context) {
        mList = list;
...
//        System.out.println(mList.size()+"Myadadad");
        System.out.println("my date: "+mList.size());
        return mList.size();
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.button3.setText("取消");
        holder.linearLayout.setVisibility(View.VISIBLE);
        Log.i("ReservationTime",position+":list:"+mList.size());
        holder.orderTime.setText(Tools.getStringDate(mList.get(position).getReservationTime()));
        holder.orderPhone.setText("18065019361");
        holder.button3.setOnClickListener(new View.OnClickListener() {
            //取消事件
            @Override
            public void onClick(View v) {
                holder.button3.setVisibility(View.GONE);
                holder.quxiao.setVisibility(View.VISIBLE);
            }
        });
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            quxiao = itemView.findViewById(R.id.textView9);
        }
    }
}
